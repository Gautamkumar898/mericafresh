...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title text-primary">Produce Details</h3>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            $query = $db->query("select produce_id,product_name,category_name,price,unit_metrics,packaging,product_image1,user_id from user_product inner join product on user_product.produce_id=product.p_id  inner join category on category.category_id=product.product_category  where user_product.user_id=$id");
                            ...
                            <td>
                                <a href="#" data-toggle="modal" data-target="#myModal<?= $value['f_id']; ?>" data-toggle="tooltip" title="view " class="" data-placement="top"><i class="fas fa-eye text-info" style="font-size: 18px;"></i></a>
