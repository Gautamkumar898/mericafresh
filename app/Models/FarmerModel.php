...
class FarmerModel extends Model
{
    ...
    protected $allowedFields = ['f_id',	'farmer_id',	'farmer_name',	'farmer_email',	'farmer_phone','farmer_mobile',	'farmer_website',	'farmer_owner',	'fb_url','instagram_url','farmer_bussiness_type',	'farmer_status','cultivable_land',	'created_at',	'updated_at',	'added_by'];
